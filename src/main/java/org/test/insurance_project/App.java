...
public class App 
{
    ...
    driver.get("http://3.109.206.97:8081/contact.html");	
    ...
    // driver.findElement(By.cssSelector("[fdprocessedid='2x5n1b']")).click();
    ...
    File destFile = new File("/home/ubuntu/sel-test-reports.jpg");
